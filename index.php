...
<html>
	...
	<body style="min-width: 980px;">
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/chocholate.php">
							...
							<div style="float: buttom;"><h1>Chocolate Cake</h1></div>
						</div>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/vanilla.php">
							...
							<div style="float: buttom;"><h1>Vanilla Cake</h1></div>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/mango.php">
							...
							<div style="float: buttom;"><h1>Mango Cake</h1></div>
						</div>
					</li>
				</ul>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/orange.php">
							...
							<div style="float: buttom;"><h1>Orange Cake</h1></div>
						</div>
					</li>
				</ul>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/redVelvet.php">
							...
							<div style="float: buttom;"><h2>RedVelvet Cake</h2></div>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/bento.php">
							...
							<div style="float: buttom;"><h1>Bento Cake</h1></div>
						</div>
					</li>
				</ul>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/lemon.php">
							...
							<div style="float: buttom;"><h1>Lemon Cake</h1></div>
						</div>
					</li>
				</ul>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/jar.php">
							...
							<div style="float: buttom;"><h1>Jar Cake</h1></div>
						</div>
					</li>
				</ul>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/tub.php">
							...
							<div style="float: buttom;"><h1>Tub Cake</h1></div>
						</div>
					</li>
				</ul>
		...
		<div style="float:left; width:100%; height: 60px; background:#c9e9e6; text-align: center;color : red;"><h3>Note:IF YOU NEED CUSTOMISE LIKE FONDENT OR ANY THEME CAKE THEN YOU PAY SOME EXTER COST & MINIMUM 1-2 DAYS BEFORE ORDER CONFIRM DELIVERY DATE . </h3> </div>
